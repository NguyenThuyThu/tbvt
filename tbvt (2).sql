...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2020 at 03:23 AM
...
--
-- Dumping data for table `tbl_chitiet_hoadonmua`
--

INSERT INTO `tbl_chitiet_hoadonmua` (`ma_sanpham`, `ma_hoadonmua`, `soluong_mua`, `giaban`, `tongtien`) VALUES
(1, 1, 1, '200000', '200000');
...
--
-- Dumping data for table `tbl_chitiet_phieunhaphang`
--

INSERT INTO `tbl_chitiet_phieunhaphang` (`ma_sanpham`, `ma_phieunhap`, `soluong_nhap`, `dongia_nhap`, `thanhtien`) VALUES
(1, 1, 120, '100000', '12000000');
...
--
-- Dumping data for table `tbl_hoadon_muahang`
--

INSERT INTO `tbl_hoadon_muahang` (`ma_hoadonmua`, `ngaylap_hoadonmua`, `chiphi_giaohang`, `chiphi_lapdat`, `ghichu_hoadonmua`, `ma_hinhthucthanhtoan`, `nguoimuahang`, `nguoilap_donhang`, `nguoigiao_donhang`, `ma_trangthai_giaohang`) VALUES
(1, '13/03/2020', '0', '0', '', 1, 43246, 43246, 17622, 2);
...
INSERT INTO `tbl_phieunhaphang` (`ma_phieunhap`, `thoigian_nhap`, `ghichu_nhap`, `nguoilap_phieunhap`, `ma_nhacungcap`) VALUES
(1, '12/03/2020', '', 1, 1);
...
--
-- Dumping data for table `tbl_trangthai_giaohang`
--

INSERT INTO `tbl_trangthai_giaohang` (`ma_trangthai_giaohang`, `ten_trangthai_donhang`) VALUES
(1, 'Chờ thanh toán'),
(2, 'Chờ lấy hàng'),
(3, 'Đang giao'),
(4, 'Đã giao'),
...
ALTER TABLE `tbl_diachi`
  ...
  ADD KEY `fk_thanhvien_diachi` (`ma_thanhvien`);
...
--
-- Indexes for table `tbl_trangthai_giaohang`
--
...
--
-- AUTO_INCREMENT for table `tbl_binhluan_sanpham`
--
ALTER TABLE `tbl_binhluan_sanpham`
  MODIFY `ma_binhluan` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_danhgia_sanpham`
--
ALTER TABLE `tbl_danhgia_sanpham`
...
--
ALTER TABLE `tbl_diachi`
  MODIFY `ma_diachi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `tbl_hinhthucthanhtoan`
  MODIFY `ma_hinhthucthanhtoan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_hoadon_muahang`
--
ALTER TABLE `tbl_hoadon_muahang`
  MODIFY `ma_hoadonmua` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_phieunhaphang`
  MODIFY `ma_phieunhap` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `tbl_trangthai_giaohang`
--
ALTER TABLE `tbl_trangthai_giaohang`
  MODIFY `ma_trangthai_giaohang` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- Constraints for table `tbl_binhluan_sanpham`
--
ALTER TABLE `tbl_binhluan_sanpham`
...
--
-- Constraints for table `tbl_danhgia_sanpham`
--
ALTER TABLE `tbl_danhgia_sanpham`
...
--
-- Constraints for table `tbl_hoadon_muahang`
--
ALTER TABLE `tbl_hoadon_muahang`
...
--
-- Constraints for table `tbl_phieunhaphang`
--
ALTER TABLE `tbl_phieunhaphang`
