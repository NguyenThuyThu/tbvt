...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 08, 2020 lúc 03:21 PM
...
--
-- Error reading structure for table thietbivienthong.tbl_cart: #1932 - Table 'thietbivienthong.tbl_cart' doesn't exist in engine
-- Error reading data for table thietbivienthong.tbl_cart: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `thietbivienthong`.`tbl_cart`' at line 1
...
CREATE TABLE `tbl_diachi` (
  `ma_diachi` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
