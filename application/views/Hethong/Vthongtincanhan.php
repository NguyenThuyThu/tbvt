                            ...
                            <form action="" method="post" class="form-horizontal" accept-charset="utf-8" enctype="multipart/form-data" autocomplete="off">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <input type="date" name="ngaysinh" class="form-control datepicker" value="{if !empty($canbo)}{$canbo[0]['ngaysinh']}{/if}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="radio" name="gioitinh" value="Nữ" {if !empty($canbo)} {if $canbo[0]['gioitinh']=='Nữ'}checked{/if}{/if}> Nữ
                                            </div>
                                        </div>
                                    </div>
