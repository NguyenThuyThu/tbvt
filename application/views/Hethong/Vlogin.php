...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{base_url()}index2.html"><b>Đăng nhập</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form  method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="{base_url()}" class="btn btn-success btn-block btn-flat">Trang chủ</a>
                        </div>
                        <!-- /.col -->
                        <div class="col-6">
                            <button type="submit" class="btn btn-primary btn-block btn-flat" name="dangnhap" value="1">Đăng nhập</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
