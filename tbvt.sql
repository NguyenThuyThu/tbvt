...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2020 at 07:15 PM
...
('SP001', 'HD001', 3, '6490000', '19470000'),
('SP002', 'HD002', 2, '6490000', '12980000');
...
--
-- Table structure for table `tbl_dmsanpham`
--
...
--
-- Dumping data for table `tbl_dmsanpham`
--
...
CREATE TABLE `tbl_hoadonmua` (
  `ma_hoadonmua` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ngaylap` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `chiphi_giao` decimal(10,0) NOT NULL,
...
('HD001', '23/03/2020', '0', '0', '', '1', 'TK003', 'TK003', '3'),
('HD002', '23/03/2020', '0', '0', '', '1', 'TK004', 'TK004', '2');
...
--
-- Indexes for table `tbl_dmsanpham`
--
