...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2020 at 06:45 PM
...
--
-- AUTO_INCREMENT for table `tbl_chitiet_hoadonmua`
--
ALTER TABLE `tbl_chitiet_hoadonmua`
  MODIFY `ma_chitiet_hoadonmua` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_chitiet_phieunhaphang`
--
ALTER TABLE `tbl_chitiet_phieunhaphang`
...
--
-- Constraints for table `tbl_chitiet_hoadonmua`
--
ALTER TABLE `tbl_chitiet_hoadonmua`
...
--
-- Constraints for table `tbl_chitiet_phieunhaphang`
--
ALTER TABLE `tbl_chitiet_phieunhaphang`
